---
title: Rivanna Storage Options
subtitle: Storage locations, I/O performance, and cleanup/reporting scripts for Dremel Lab
author: Dremel Lab
    ...
    include-before-body:
      text: |
        <nav class="guide-nav">
          ...
          <a href="../s3-globus-access/s3_globus_access_guide.html">Getting Access to Dremel Lab S3 Files via Globus</a>
          <span class="guide-nav-sep">·</span>
          <span class="guide-nav-current">Rivanna Storage Options</span>
        </nav>
        <div class="date-info">
          <div>
