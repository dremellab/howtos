      ...
      text: |
        <div class="date-info">
          <div>
            ...
            <span class="date-value">May 11, 2026</span>
          </div>
          <div>
...
**If you need AWS SA credentials:** Rivanna users can find them at `/project/dremel_lab/scripts/aws_globus_sa_credentials.txt`. If you don't have Rivanna access, email Sarah Dremel (qdt2nz@virginia.edu) and they will send you the credentials file.
...
Email Sarah Dremel (qdt2nz@virginia.edu) for help getting UVA account access or Globus configured.

**Option 2: Direct S3 access via AWS credentials**
1. Email Sarah Dremel asking for the AWS SA credentials file
2. She'll send you `aws_globus_sa_credentials.txt` (which contains Access Key ID and Secret)
...
✓ **AWS SA credentials available:** Rivanna users can find credentials at `/project/dremel_lab/scripts/aws_globus_sa_credentials.txt`. Non-Rivanna users can email Sarah Dremel.
